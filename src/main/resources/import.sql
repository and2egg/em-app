...
insert into location (id,name,timezone,em_id) values(1,'Helsinki','Europe/Helsinki',1);
...
insert into location (id,name,timezone,em_id) values(5,'Brussels','Europe/Brussels',3);
