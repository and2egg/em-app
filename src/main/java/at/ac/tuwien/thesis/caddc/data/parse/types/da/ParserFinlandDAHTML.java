 ...
 */
public class ParserFinlandDAHTML implements Parser {
	 ...
	 */
	public ParserFinlandDAHTML(int rowOffset, Integer[] colIndices) {
	...
	public List<String> parse(Resource resource) {
		...
		int count = 0;
		boolean DST = false; // checks if one hour is missing (DST = true)
