...
import at.ac.tuwien.thesis.caddc.data.resource.rt.ResourceManagerOhioRT;
 ...
 */
public class MarketDataOhioRT extends MarketDataRT {
	
	/**
	 * Create a MarketData Instance with the given location
	 * @param location the location for this MarketData Instance
	 */
	public MarketDataOhioRT(Location location, RTPricePersistence persistence) {
		super(location, persistence);
		this.resourceManager = new ResourceManagerOhioRT();
	}
}
