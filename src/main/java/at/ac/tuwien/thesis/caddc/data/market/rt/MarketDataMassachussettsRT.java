...
import at.ac.tuwien.thesis.caddc.data.resource.rt.ResourceManagerMassachussettsRT;
 ...
 */
public class MarketDataMassachussettsRT extends MarketDataRT {
	
	/**
	 * Create a MarketData Instance with the given location
	 * @param location the location for this MarketData Instance
	 */
	public MarketDataMassachussettsRT(Location location, RTPricePersistence persistence) {
		super(location, persistence);
		this.resourceManager = new ResourceManagerMassachussettsRT();
	}	
}
